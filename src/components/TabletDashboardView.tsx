...
export default function TabletDashboardView({
  ...
  const submitTicketNumber = (rawNum: string) => {
    ...
    setManualFeedback({ type: 'success', message: `Ticket #${cleanNum} añadido automáticamente` });
    setNumpadValue('');
    setTimeout(() => setManualFeedback(null), 2000);
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <button
              ...
              className={`sm:col-span-2 py-5 px-6 rounded-2xl font-black text-xl sm:text-2xl flex items-center justify-center gap-3 shadow-2xl transition-all cursor-pointer active:scale-95 border ${
            ...
            <button
              ...
              className={`py-3.5 px-4 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 border transition-all cursor-pointer active:scale-95 ${
                activeTicket
